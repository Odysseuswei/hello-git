...
//
  ...
  PRINTF2(fp,"    kurtosis     check        cost    disagree\n-------------------------");
  PRINTF2(fp,"------------------------------------------------------------\n");
  ...
  for (int l=0; l<=L; l++) {
    ...
    for (int m=0; m<8; m++) sums[m] = sums[m]/N;
    ...
    PRINTF2(fp,"%2d   %8.4e  %8.4e  %8.4e  %8.4e  %8.4e  %8.4e  %8.4e  %8.4e  \n", l,del1[l],del2[l],var1[l],var2[l],kur1[l],chk1[l],cost[l],sums[7]);
  }
